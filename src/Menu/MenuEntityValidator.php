...
class MenuEntityValidator extends Validator
{
    public function validateMenuEntity($menu_entity)
    {
        ...
        isset($params['splitted_menu_next_trigger']) and
        !is_string($params['splitted_menu_next_trigger']) and
        exit("The parameter 'splitted_menu_next_trigger' must be a string.");
        ...
        isset($params['back_action_trigger']) and
        !is_string($params['back_action_trigger']) and
        exit("The parameter 'back_action_trigger' must be a string.");
